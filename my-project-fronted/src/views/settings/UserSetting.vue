...
<template>
    <div style="display: flex;max-width: 950px;margin: auto">
        ...
        <div class="settings-left">
            <Card v-loading="loading.form" :icon="User"
                ...
                <el-form ref="baseFormRef" :model="baseForm" :rules="rules" label-position="top"
                    ...
                    <el-button :icon="Select" :loading="loading.base" type="success" @click="saveDetails">保存用户信息
                    </el-button>
                </el-form>
            </Card>
            <Card :icon="Message" desc="您可以在这里修改默认绑定等等电子邮件地址" style="margin-top: 10px"
                  title="电子邮件设置">

                <el-form ref="emailFormRef" :model="emailForm" :rules="rules" label-position="top"
                         style="margin: 0 10px 10px 10px" @validate="onValidate">
                    ...
                    <el-form-item prop="code">
                        <el-row :gutter="10" style="width: 100%">
                            ...
                            <el-col :span="6">
                                <el-button :disabled="!isEmailValid || coldTime > 0" plain style="width: 100%"
                                           type="success"
                                           @click="sendEmailCode">
